...
<div class="navbar navbar-inverse navbar-fixed-top">
  <div class="navbar-inner">
    <div class="container">
      <a class="brand" href="#">Glassware Java Project</a>
    </div>
  </div>
</div>
    ...
    <div class="span4">
      <h2>Timeline</h2>
       ...
       <form action="<%= WebUtil.buildUrl(request, "/main") %>" method="post">
        <input type="hidden" name="operation" value="cronjob">
      ...
      <form action="<%= WebUtil.buildUrl(request, "/main") %>" method="post">
        ...
        <textarea class="span4" name="message">Insert a Timeline item.</textarea><br/>
        <button class="btn btn-block" type="submit">
          Insert the message
        </button>
      </form>
      ...
      <form action="<%= WebUtil.buildUrl(request, "/main") %>" method="post">
        <input type="hidden" name="operation" value="insertItem">
        <textarea class="span4" name="message">Insert a Timeline item.</textarea><br/>
        <input type="hidden" name="imageUrl" value="http://b-open.nl/Uploaded_Images/images/menigte.jpg">
        <input type="hidden" name="contentType" value="image/jpeg">

        <button class="btn btn-block" type="submit">Insert message with a picture
          <img class="button-icon" src="http://b-open.nl/Uploaded_Images/images/menigte.jpg">
        </button>
      </form>
    </div>
  </div>
